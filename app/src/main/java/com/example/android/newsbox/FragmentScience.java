 ...
 */
public class FragmentScience extends Fragment implements LoaderManager.LoaderCallbacks<List<Article>> {

    private final static String REQUEST_URL_BASE = "http://content.guardianapis.com/search?show-tags=contributor&show-fields=headline,trailText,thumbnail,body&use-date=published&section=science";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_science, container, false);

        // RecyclerView
        RecyclerView articleRecyclerView = (RecyclerView) rootView.findViewById(R.id.science_recycler_view);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    if ((visibleItemCount + pastVisibleItems) >= totalItemCount) {
                        loading = false;
                        getLoaderManager().initLoader(NEWS_REQUEST_ID, null, FragmentScience.this).forceLoad();
                    }
                }
            }
        });
        ...
        // Refresh
        swipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.science_swipe_refresh);
