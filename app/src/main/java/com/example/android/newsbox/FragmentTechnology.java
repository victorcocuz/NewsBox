 ...
 */
public class FragmentTechnology extends Fragment implements LoaderManager.LoaderCallbacks<List<Article>> {

    private final static String REQUEST_URL_BASE = "http://content.guardianapis.com/search?show-tags=contributor&show-fields=headline,trailText,thumbnail,body&use-date=published&section=technology";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // RecyclerView
        RecyclerView articleRecyclerView = (RecyclerView) rootView.findViewById(R.id.technology_recycler_view);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    if ((visibleItemCount + pastVisibleItems) >= totalItemCount) {
                        loading = false;
                        getLoaderManager().initLoader(NEWS_REQUEST_ID, null, FragmentTechnology.this).forceLoad();
                    }
                }
            }
        });
        ...
        // Refresh
        swipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.technology_swipe_refresh);
